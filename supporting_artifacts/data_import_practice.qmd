...
```{r}
library(readr)
read_csv(here::here("supporting_artifacts", "supporting_data", "ages.csv"))
...
read_table(here::here("supporting_artifacts", "supporting_data", "ages_tab.txt"))
...
read_delim(here::here("supporting_artifacts", "supporting_data", "ages_mystery.txt"), delim = "|")
...
readxl::read_excel(here::here("supporting_artifacts", "supporting_data", "ages.xlsx"))
...
read.csv(here::here("supporting_artifacts", "supporting_data", "ages.csv"), colClasses = c("factor","character"))
