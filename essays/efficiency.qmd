...
In Lab 3, I learned how to use the across() function (problem 7), which saved me from having to write out the same computation for several columns.

In Lab 4 problems 3 and 5, I learned how to use semi_join and anti_join to subset rows, instead of using %in% with a long list of values.
